...
describe "Beerlist page" do
  ...
  it "shows beers in alphabetical order as default", js:true do
    visit beerlist_path
  ...
  it "ordering by style orders beers according to their style name", js:true do
    visit beerlist_path
    click_link "Style"
  ...
  it "ordering by brewery orders beers according to their brewery name", js:true do
    visit beerlist_path
    click_link "Brewery"
